...
bot.on('guildMemberAdd', member => {
    ...
    member.send('**' + member.user.username + '**, has joined the server! there are now ' + member.guild.memberCount + ' now'); 
});

bot.on('guildMemberRemove', member => {
    member.guild.channels.get("name","welcome-leave")
    member.send('**' + member.user.username + '**, has left the server! there are now ' + member.guild.memberCount + ' now');
});
