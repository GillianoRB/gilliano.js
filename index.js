...
bot.on('guildMemberAdd', member => {
    member.guild.channels.get('welcome-leave').send('**' + member.user.username + '**, has joined the server! there are now ' + member.guild.memberCount + ' now'); 
    member.addRole(member.guild.roles.find(role => role.name === "Guests"));
});

bot.on('guildMemberRemove', member => {
    member.guild.channels.get('welcome-leave').send('**' + member.user.username + '**, has left the server! there are now ' + member.guild.memberCount + ' now');
});
