        ...
        if (message.content.startsWith("!math5")) {
          ...
          if (message.content.startsWith('!info')) {
            ...
            const info = new Discord.MessageEmbed()
                ...
                .setAuthor(user.author.username, user.author.avatarURL()) //Heading With Username & Their Avatar 
                .setTitle('UserInfo')
                .setURL('www.google.com') //Any Vaild Link
                .setColor('RANDOM') //You Can Use HexColour Ex:- #000000
                .setImage(user.author.avatarURL()) //Add Any Image URl || Image
                .setThumbnail(user.author.avatarURL()) //Add Any Image URl || ThumbNail
    
                //All Feilds Are Just Examples pick Some & add as you like
    
                .addField('Avatar', user.author.avatar, true) //The ID of the user's avatar //Inline True or false
                .addField('AvatarURL', user.author.avatarURL({
                    format: 'png'
                ...
                .addField('Bot', user.author.bot, true) //Returns True If Message Author = Bot || False If Message Author not Bot.
                .addField('Created At', user.author.createdAt, false) //The time the user was created || .createdTimestamp - The timestamp the user was created at
                .addField('Discrim', user.author.discriminator, true) //A discriminator/tag based on username for the user Ex:- 0001
                .addField('DMChannel', user.author.dmChannel) //The DM between the client's user and this user || If Nothing Returns "Null"
                .addField('ID', user.author.id) //The ID of the User/author
                .addField('Last Message', user.author.lastMessage) //The Message object of the last message sent by the user, if one was sent
                .addField('Last Message ID', user.author.lastMessageID) //The ID of the last message sent by the user, if one was sent
                .addField('Presence', user.author.presence) //The presence of this user
                .addField('Presence Status', user.author.presence.status) //The presence status of this user
                .addField('Presence Game', user.author.presence.activity.name) //The presence Game of this user
                .addField('Tag', user.author.tag) //The Discord "tag" for this user || Ex:- Sai Chinna#6718
                .addField('Username', user.author.username) //The username of the user || Ex:- Sai Chinna
                .addField('Nick Name', user.guild.member(target).displayName) //Nick Name In That (message sent) server || Define target as message Author Ex:- let target = message.author; || Add This Line in Top
